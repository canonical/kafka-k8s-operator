...
To deploy [Traefik K8s operator](https://charmhub.io/traefik-k8s) and enable ingress on your Juju K8s cluster, follow the [official documentation](https://documentation.ubuntu.com/traefik-k8s-charm/latest/).
