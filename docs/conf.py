...
project = "Charmed Apache Kafka K8s"
...
ogp_site_url = "https://canonical-charmed-kafka-k8s.readthedocs-hosted.com/"
...
html_context = {
    ...
    "github_url": "https://github.com/canonical/kafka-k8s-operator",
...
#
html_theme_options = {
'source_edit_link': 'https://github.com/canonical/kafka-k8s-operator',
}
...
html_baseurl = 'https://canonical-charmed-kafka-k8s.readthedocs-hosted.com/'
